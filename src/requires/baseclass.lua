    ...
    function program.onStart()
        -- Local functions for onStart
            ...
            local function atlasSetup()
                ...
                local altTable = {
                    -- Vanilla planets (measured values)
                    [1]=6637, [2]=3426, [3]=21452, [4]=7580, [6]=4498, [7]=6285, [8]=3434, [9]=5916, [26]=4242, [27]=4150,
                    -- Madis,   Alioth,  Thades,    Talemai, Sicari,  Sinnen,  Teoma,  Jago,   Sanctuary, Haven
                    -- Prime planets (calculated from atmosphereThickness)
                    [5]=42825, [45]=3426, [48]=6424, [49]=4226, [54]=6852, [58]=4283, [59]=5139, [61]=6424, [62]=4283, [66]=5996, [67]=3426, [71]=21413, [72]=3426,
                    -- Feli,    AliothP,  IonP,      JagoP,     LacobusP,  MadisP,   SicariP,   SinnenP,   SymeonP,   TalemaiP,  TeomaP,    ThadesP,     ConsortiumHW
                } -- Min space engine altitudes. Vanilla=measured, Prime/custom=0.5353125*atmosphereThickness
