...
-- Ship Handling variables
    ...
    AtmoSpeedLimit = 50000 --export: (Default: 50000) Speed limit in Atmosphere in km/h. AtmoSpeedAssist will cause ship to throttle back when this speed is reached. Consortium: no atmo speed limit enforced server-side.
    SpaceSpeedLimit = 50000 --export: (Default: 50000) Space speed limit in KM/H. If you hit this speed and are NOT in active autopilot, engines will turn off to prevent using all fuel (50000 means they wont turn off)
    ...
    MaxGameVelocity = 13888.89 --export: (Default: 13888.89) Max speed for your autopilot in m/s (50000 km/hr). Consortium server max speed. Can be reduced to save fuel.
