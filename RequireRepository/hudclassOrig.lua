...
-- Modify beyond here as you will
    ...
    --Local Huds Functions
        ...
        local function DrawWarnings(newContent)
            ...
            newContent[#newContent + 1] = svgText(ConvertResolutionX(1900), ConvertResolutionY(1070), stringf("ARCH Hud Version: %s", VERSION_NUMBER), "hudver")
